...
const TOPIC_CHANNELS: CommunityChannel[] = [
  ...
  { id: "ch-cosplays", group: "topic", order: 5, icon: "👗", title: "Ваши косплеи", preview: { author: "", text: "" }, time: "" },
  { id: "ch-crafts", group: "topic", order: 6, icon: "🛠", title: "Клуб очумелые ручки", preview: { author: "", text: "" }, time: "" },
  { id: "ch-services", group: "topic", order: 7, icon: "✈️", title: "Услуги", preview: { author: "", text: "" }, time: "" },
  { id: "ch-rental", group: "topic", order: 8, icon: "⭐", title: "Аренда костюмов/крафтов", preview: { author: "", text: "" }, time: "" },
  { id: "ch-cocosplay", group: "topic", order: 9, icon: "🔍", title: "Поиск сокосплееров", preview: { author: "", text: "" }, time: "" },
  { id: "ch-blacklist", group: "topic", order: 10, icon: "❗", title: "Черный список косплей комьюнити", preview: { author: "", text: "" }, time: "", locked: true, pinned: true },
];
