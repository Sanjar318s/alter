...
const ROLES: {
...
}[] = [
  {
    id: "client",
    title: "Клиент",
    tip: "Смотрите рилсы и биржу готовых работ, заказывайте у продавцов, если услуга доступна. Свои работы не публикуете.",
    icon: ShoppingBag,
  },
  {
    id: "blogger",
    title: "Блогер",
    tip: "Публикуйте рилсы о косплее и ведите профиль. Биржа работ недоступна — только видео-контент. Нужна активность: новый рилс не реже чем раз в 60 дней.",
    icon: Clapperboard,
  },
  {
    id: "seller",
    title: "Продавец",
    tip: "На бирже — готовые работы, в рилсах — процесс создания. Принимайте заказы в студии, если включили «Предоставляю услуги». Активность: работа или рилс раз в 60 дней.",
    icon: Store,
  },
];
