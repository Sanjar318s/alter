...
export default function PartnersPage() {
  ...
  return (
    <LegalPage eyebrow="Партнёрам" title="Конвенты, ателье, медиа">
      <p>
        AlterCosPlay — портфолио, заказы и комьюнити для косплееров, мейкеров и блогеров. При согласии автора
        контент может выходить на брендовые аккаунты YouTube, Instagram, Facebook и TikTok. Ищем партнёров:
        организаторов фестов, ателье, фотостудии и медиа.
      </p>
